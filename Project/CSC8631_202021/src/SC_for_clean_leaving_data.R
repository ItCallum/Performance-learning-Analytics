##The following is the code for the cleaning and anlysis of the 
...
Anyone_comp_week_less_than_last_step <- na.omit(combine_Leaving_NoDups) %>% filter(last_completed_week_number < last_completed_week_number) 
