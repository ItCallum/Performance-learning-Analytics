...
In this I performed an EDA while using the CRISP-dm model to find ways that Newcastle University could increase people completeing their online summer classes. My business object was "give useful insights into why people decide to leave the course".

- Background

Newcastle University has gathered information about the users that have attended an online course and are wanting to perform learning Analytics on this data to get insight into student engagement.
